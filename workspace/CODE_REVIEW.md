...
- **Fixed (10):** #1 (return types), #2–#3 (unused params), #4 (moduleResolution), #5 (discriminated union), #6 (query scope), #8 (type predicates), #9 (shared interface), #10 (unsafe cast), #11 (comment)
- **Won't Fix (2):** #7 (private interfaces kept for documentation), #12 (isolatedModules kept for consistency)
